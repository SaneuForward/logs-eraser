<?php
// install for ubuntu/debain apt-get install php7.0-cli -y -> centos nothing to be installed for now!
// usage php Log_Eraser.php
@error_reporting(0);
set_time_limit(0);
system("clear");
 
print "|--=--=--=--=--=--=--=--=--=--=--=--=--=------------|\n";
print "|Log Eraser PHP by Sanzu                            |\n";
print "|--=--=--=--=--=--=--=--=--=--=--=--=--=------------|\n";
...
print "Take Care of Your Ass !!! :D #Sanzu4Ever \n";
